...
mod tests {
    ...
    #[test]
    fn part1() {
        assert_eq!(7036, super::part1(get_example()));
        assert_eq!(11048, super::part1(get_example2()));
    }

    #[test]
    fn part2() {
        assert_eq!(45, super::part2(get_example()));
        assert_eq!(64, super::part2(get_example2()));
    }
}
