...
namespace input
{
    constexpr std::array equations{
        "6 * 8 * (2 * 9) + 2 * 8 * 4",
        "(2 + 2 * 4 * (8 * 9 * 2 + 6) * 4) * 2",
        "2 * (7 + 3 * 5 * 7 * 6) + 9 * 4",
        "((8 * 4 * 7 + 9 + 8) * (6 * 4) + 7 * 9 * 8 + 3) * (9 + 6 + 8 + 2 + (6 * 4 * 6) * (9 + 7 * 6 * 5 + 5 * 3)) * 8 "
        "* 8",
        ...
        "2 * 3 + ((6 + 8 + 8) + 5 + 8)",
        "4 * (6 * 4 * 5 + (9 * 3 + 4 + 2) * 2)",
        "(7 * 4 + (6 * 8 + 9 + 4 * 9 * 5) + 3 * 6 + (2 + 8 * 9 * 4 * 6)) + 7 + 9 * (6 + (5 + 8 + 9 * 6 + 5) * 9 * 7 + "
        "2) + 4",
        ...
        "(9 + 6 * 8 + (4 * 7 + 8 + 5 + 2) + 3 * 2) + 3 * (2 * (6 + 7 + 3 + 4 + 6) + 8 + 5 * 2) * (8 * (4 * 7 + 5 * 7) "
        "+ 4) + 5",
        "9 + (2 * (5 * 7) * (5 * 7 * 7) * 7 * 4) + 7 * (5 * 9 + (9 * 7 * 7 * 2))",
        "5 * 8 + 4 + (4 * 4) + 7 * 7",
        "6 + (3 + (2 + 6) + 3) + 2",
        "(3 + 9 * (7 + 4 * 8 * 8) + (4 + 9) * 9 * 2) + 9",
        "6 * 4 * ((4 + 3 * 5 * 4) * 3 + (5 + 7 + 6 + 8 * 6) + (2 + 3 + 2 + 3 * 3) * (6 * 8 * 2)) * (3 * (9 * 8 * 4 + 4 "
        "* 3 + 3) + (4 + 8 + 9))",
        ...
        "9 * 2 * 8 * 5 * 2 + 7",
        "7 + 8 * (9 * 9 * 3 + (5 * 6 * 9 * 4 * 8) + 3 * 6) + ((7 * 2 * 5 * 3) * 3 + (2 * 5 + 9 + 8 * 4) * 6 + 9 + 5) + "
        "3",
        "3 + (3 + 8 * 3 + 3 * 6 + (2 + 8)) * 2 * (9 * (3 + 2) + (3 + 9 + 7) * 7 + (9 + 3 * 7 + 2)) * ((8 * 2) * 3 * 8 "
        "+ 3)",
        ...
        "3 * (5 * 6 + 3 + 9 * 2 + (6 * 6 * 9 * 6 + 2)) + 8 + 9 + ((5 + 6 * 3 + 9 * 9 + 8) + 3 * 9 + (4 + 4 * 7 * 7 + "
        "6) + 3) * 7",
        ...
        "(7 + (9 * 3)) + 2 + 7 + ((4 + 4 + 8 + 7 * 6 * 2) * (7 + 3 + 5 * 4 + 2 + 4) + 4) * (4 + 7 + (6 * 4 + 4 * 7)) + "
        "((2 * 2 + 8 * 4 + 6) + 9 * 2 + 7 + (6 + 6 * 9))",
        ...
        "3 + 4 * 2 + (2 * 4 + 9 + 5)",
        "((9 * 2 + 7) + 5 + (2 * 9 + 8 + 6) + 8 * 7) * 4 * 5 + (8 * 2 + 9 * 9 + (2 * 5 * 8 + 5 * 5) + 7) + (5 + (8 + 5 "
        "* 9 * 7 + 7 * 8) + 6 * 3 * 3)",
        ...
        "(8 + (8 + 9 * 2 * 6) + 5) * 2 + 8",
        "8 + 2 + 5 * 7",
        "(9 + (4 + 8 + 3 + 6 * 3)) * 7 + ((4 * 8 + 3 * 7 * 5 * 9) + 4) * ((5 * 9 * 5 + 6) * (6 + 2 + 8) * (7 * 8 * 8) "
        "+ 9 * 7 + 9) + 2",
        "5 + 7 * 7 * 3 + (5 * 2)",
        ...
        "3 + 5 + ((4 + 9) * 7 * 6)",
        "7 * 2 * 7 * 9 * (7 * (7 * 6 + 2) * (6 + 8 + 9 + 9) + (3 + 7 + 5 * 2) + 2) * (9 * (8 + 9 + 8 + 6 * 2 + 2) + 5 "
        "* (3 + 8 + 7 * 4))",
